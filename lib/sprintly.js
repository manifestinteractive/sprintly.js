...
var sprintly_api = {
	...
	{
		// Put your custom debugger here
		if(typeof app !== 'undefined')
		{
			app.util.debug(level, message);
		}
	},
	track: function(category, action, label, value)
	{
		// Put your custom analytics here
		if(typeof app !== 'undefined')
		{
			app.stats.event(category, action, label, value);
		}
	}
};
...
sprintly_api.item.get = function(item_id)
{
	...
	if(sprintly_api.product.selected)
	{
		sprintly_api.call(
			...
			function(error)
			{
				sprintly_api.item.data.get_item = null;
